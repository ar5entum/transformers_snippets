...
print("\033[94m!!USING Wav2Vec2PhonemeCTCTokenizer MODIFIED WITH TRANSPHONE!!\033[0m")
...
class Wav2Vec2PhonemeCTCTokenizer(PreTrainedTokenizer):
    ...
    def init_backend(self, phonemizer_lang: str):
        ...
        self.backend = read_tokenizer(phonemizer_lang, device='cuda')
    ...
    def phonemize(self, text: str, phonemizer_lang: Optional[str] = None) -> str:
        ...
        #     separator=separator,
        # )
        phonemes = " ".join(self.backend.tokenize(text, use_space=True)).replace('<SPACE>', '$')
